            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ route('console') }}"><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a href="{{ route('table') }}"><i class="fa fa-edit"></i> Registration <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Question <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
