...
<div class="wrap">
    ...
    <h1>Studio Room is reserved</h1>
    <hr>
    <p class="start-end">Dear {{ $applicant->firstname }},</p>
    <p>Thank you for your interest in our TEDxKMITL event.</p>
    <p>We would like to inform you that you've got a seat in studio!</p>
    <a href="#">Click this</a><p>to perform a payment process. Noted that you
    have to process this in three day after getting this email, otherwise you will lost your seat</p>
