    ...
    <div class="small-12 columns">
        <div class="card">
            <div class="card-section">
                ...
                <p>ระยะเวลาการสมัครถึงวันที่ 9 เมษายน 2560 เวลา 23.59 น.</p>
                <p>ติดต่อสอบถาม tedxkmitl@gmail.com</p>
                <p>คุณสามารถเซื้อบัตรเข้าร่วมกิจกรรม After Party ที่จัดขึ้นในช่วงท้ายได้ที่จุดลงทะเบียน ในราคา 100 บาท</p>
            </div>
        </div>
    </div>
</div>
<form name="apply" action="/apply" method="post" onsubmit="submission_control()" data-abide>
    ...
    <div class="row">
        ...
        <div class="small-12 columns">
            <div class="card">
                <div class="card-section">
                    <p>เมื่อคุณกดปุ่มส่งข้อมูล หมายความว่าคุณสามารถเข้าร่วมงาน TEDxKMITL ในวันที่ 22 เมษายน 2560</p>
                </div>
            </div>
        </div>
