...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/foundation.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/production.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/animations.min.css')); ?>">
    <script>
        document.createElement("picture");
    </script>
    <script src="<?php echo e(asset('js/picturefill.min.js')); ?>" async></script>
</head>
<body>
<section id="main">
    <div class="row">
...
<section id="partner">
    ...
    <div class="row" id="spon">
        <div class="small-3 columns"><img src="http://placehold.it/200x200" alt="" class="float-center"></div>
        <div class="small-3 columns"><img src="http://placehold.it/200x200" alt="" class="float-center"></div>
        <div class="small-3 columns"><img src="http://placehold.it/200x200" alt="" class="float-center"></div>
        <div class="small-3 columns"><img src="http://placehold.it/200x200" alt="" class="float-center"></div>
    </div>
...
<script src="<?php echo e(asset('js/vendor/what-input.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/vendor/foundation.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/css3-animate-it.min.js')); ?>" async></script>
